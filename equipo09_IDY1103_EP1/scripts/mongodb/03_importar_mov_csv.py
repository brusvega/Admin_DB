# Este script de carga sirve únicamente para importar
# los 33 archivos csv de MOV. Los otros dos archivos (clase_mov y centros)
# como son livianos se pueden importar manualmente desde MongoDB Compass

# IMPORTANTE: tener los 33 archivos en la ruta C:\datos\mov
